...
GAMEPROJECTFILE =/home/tyomavader/Documents/ProjectChess 5.2 5.2/ChessDev.uproject

TARGETS = \
	ChessDev-Linux-Debug  \
	ChessDev-Linux-DebugGame  \
	ChessDev-Linux-Test  \
	ChessDev-Linux-Shipping  \
	ChessDev \
	ChessDevEditor-Linux-Debug  \
	ChessDevEditor-Linux-DebugGame  \
	ChessDevEditor-Linux-Test  \
...
ChessDev-Linux-Debug:
	 $(PROJECTBUILD) ChessDev Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessDev-Linux-DebugGame:
	 $(PROJECTBUILD) ChessDev Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessDev-Linux-Test:
	 $(PROJECTBUILD) ChessDev Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
ChessDevEditor-Linux-Debug:
	 $(PROJECTBUILD) ChessDevEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessDevEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ChessDevEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessDevEditor-Linux-Test:
	 $(PROJECTBUILD) ChessDevEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
