...
void Game::Gwent()
{
    ...
    sqlite3_open("./src/DataBase/DB.db", &db);

    int rc = sqlite3_open("./src/DataBase/DB.db", &db);
    ...
    colodaBlack.push_b(obj_6);
    colodaBlack.push_b(obj_7);
    colodaBlack.push_b(obj_8);
    colodaBlack.push_b(obj_9);
    colodaBlack.push_b(obj_10);
